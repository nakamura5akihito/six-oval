 ...
 * Each note contains some information about the definition or tests that it references.
 * A note may record an unresolved question about the definition or test or present
 * the reason as to why a particular approach was taken.
 *
